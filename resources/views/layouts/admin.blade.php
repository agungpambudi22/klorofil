            ...
            <div class="container-fluid">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset('assets/img/apple-icon.png')}}" class="img-circle" alt="Avatar"> <span>{{ Auth::user()->name }}</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ route('logout') }}
                                    ...
                                    <i class="lnr lnr-exit"></i></i> <span>Logout</span></a>
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li><a href="{{route('pc.index')}}" class=""><i class="lnr lnr-code"></i> <span>Elements</span></a></li>
                        <li><a href="{{route('monitor.index')}}" class=""><i class="lnr lnr-chart-bars"></i> <span>Charts</span></a></li>
